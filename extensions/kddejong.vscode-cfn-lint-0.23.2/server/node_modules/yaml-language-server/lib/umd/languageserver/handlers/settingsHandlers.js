...
(function (factory) {
    ...
    class SettingsHandler {
        ...
        setConfiguration(settings) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (settings.yaml) {
                    ...
                    if ((_a = settings.files) === null || _a === void 0 ? void 0 : _a.associations) {
                    ...
                    this.yamlSettings.yamlVersion = (_b = settings.yaml.yamlVersion) !== null && _b !== void 0 ? _b : '1.2';
        ...
        getSchemaStoreMatchingSchemas(schemaStoreUrl) {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield (0, request_light_1.xhr)({ url: schemaStoreUrl });
