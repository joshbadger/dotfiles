...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/objects", "../utils/schemaUtils", "vscode-json-languageservice", "vscode-nls", "vscode-uri", "vscode-languageserver-types", "../utils/arrUtils", "../utils/strings"], factory);
    }
        ...
        function _validateNode() {
            ...
            if (Array.isArray(schema.enum)) {
                ...
                for (const e of schema.enum) {
                    if ((0, objects_1.equals)(val, e) || (typeof val === 'string' && val && e.startsWith(val))) {
                        enumValueMatch = true;
                        break;
                    }
                }
                ...
                if (itemSchema) {
                    ...
                    node.items.forEach((item) => {
                        if (itemSchema.oneOf && itemSchema.oneOf.length === 1) {
                            ...
                            const subSchema = Object.assign({}, asSchema(subSchemaRef));
